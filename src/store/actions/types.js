...
export const USER_EMAIL_SIGNUP_SUCCESSFUL = 'user_email_signup_successful';
export const USER_EMAIL_SIGNUP_FAILED = 'user_email_signup_failed';

export const USER_GOOGLE_SIGNUP = 'user_google-signup';
export const USER_GOOGLE_SIGNUP_SUCCESSFUL = 'user_google_signup_successful';
export const USER_GOOGLE_SIGNUP_FAILED = 'user_google_signup_failed';

export const LOGIN_EMAIL = 'login_email';
export const LOGIN_EMAIL_SUCCESSFUL = 'login_email_successful';
export const LOGIN_EMAIL_FAILED = 'login_email_failed';

export const USER_GOOGLE_LOGIN = 'user_google-signup';
...
export const CREATE_SUPPLIER_SUCCESSFUL = 'create_supplier_successful';
...
export const DELETE_SUPPLIER_SUCCESSFUL = 'delete_supplier_failed';
...
export const DELETE_CUSTOMER_SUCCESSFUL = 'delete_customer_failed';

export const FETCH_CUSTOMERS = 'fetch_customers';

export const PICKUP = 'pickup';
export const PICKUP_SUCCESSFUL = 'pickup_successful';
